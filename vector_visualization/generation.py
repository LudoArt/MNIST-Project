...
# 加载MNIST数据
# 因为指定one_hot=False，于是得到的labels就是一个数字，表示当前图片所表示的数字
mnist = input_data.read_data_sets("F:/mnist/to/mnist_data", one_hot=False)
